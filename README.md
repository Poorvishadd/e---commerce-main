...
eeecom organizes products into different categories, making it convenient for users to browse and shop according to their preferences. Each category presents a curated selection of products relevant to the user's interests.
...
To run the eeecom project locally, follow these steps:
...
The eecom project utilizes the following technologies and libraries:
